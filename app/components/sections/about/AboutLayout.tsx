...
// import NewsUpdateSection, { NewsItem } from "../NewsUpdateSection";
...
//   /** Passed down from the page's Sanity fetch */
//   newsItems?: NewsItem[];
//   eventItems?: NewsItem[];
// }
...
import PageHero from "../../ui/PageHero";
import NewsUpdateSection, { NewsItem } from "../NewsUpdateSection";
import AtAGlanceSection, { SanityStatItem } from "./AtAGlanceSection";
import SidebarNav, { SidebarNavItem } from "./SidebarNav";
...
interface AboutLayoutProps {
  ...
  newsItems?: NewsItem[];
  eventItems?: NewsItem[];
  /** Stats extracted from Sanity statGridBlock — passed to AtAGlanceSection */
  glanceStats?: SanityStatItem[];
}
...
export default function AboutLayout({
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {showAtAGlance && <AtAGlanceSection sanityStats={glanceStats} />}
      <NewsUpdateSection newsItems={newsItems} eventItems={eventItems} />
    </div>
  );
}