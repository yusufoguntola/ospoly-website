...
const FALLBACK_ANNOUNCEMENTS: HeroAnnouncement[] = [
  { id: '1', title: 'Engineering Faculty Secures National NBTE Accreditation for All HND Programmes', href: '/news-events' },
  { id: '2', title: '2025/2026 Admission is now open — Apply before the deadline', href: '/admission/undergraduate-studies' },
  { id: '3', title: 'Annual Inter-Faculty Sports & Cultural Festival — Registration Open', href: '/news-events' },
]
  ...
  return (
    <section className="relative w-full min-h-screen">
        ...
        >
          <div className="w-36 h-36 lg:w-50 lg:h-50 rounded-full bg-ospoly-deep backdrop-blur-sm border-4 border-ospoly-gold/30 flex flex-col items-center justify-center gap-4 text-center shadow-2xl shadow-ospoly-gold/20">
                ...
                <svg width="18" height="9" viewBox="0 0 18 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clipPath="url(#clip0_2191_198)">
                    <g clipPath="url(#clip1_2191_198)">
                      <path d="M8.79958 8.52004L4.76758 5.13204L5.57958 4.04004L8.79958 6.72804L12.0196 4.04004L12.8316 5.13204L8.79958 8.52004Z" fill="#B48B3C" />
                      <path d="M8.79958 4.73977L4.76758 1.32377L5.57958 0.259766L8.79958 2.94777L12.0196 0.259766L12.8316 1.32377L8.79958 4.73977Z" fill="#B48B3C" />
                    </g>
                  </g>
                  <defs>
                    <clipPath id="clip0_2191_198"><rect width="17.6" height="8.8" fill="white" /></clipPath>
                    <clipPath id="clip1_2191_198"><rect width="16.8" height="8.4" fill="white" transform="translate(0.399902 0.120117)" /></clipPath>
                  </defs>
                </svg>
              </div>
            </div>
            <div className="hidden group-hover:block space-y-3">
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-center mx-auto">
                ...
                <path d="M12 21.08C11.59 21.08 11.25 20.74 11.25 20.33V3.5C11.25 3.09 11.59 2.75 12 2.75C12.41 2.75 12.75 3.09 12.75 3.5V20.33C12.75 20.74 12.41 21.08 12 21.08Z" fill="#B48B3C" />
              </svg>
            </div>
          </div>
          ...
          >
            <Image src="/assets/vector.png" alt="" className="w-full h-full object-contain" height={100} width={100} />
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className="absolute bottom-5 left-0 w-full overflow-hidden leading-none">
        <svg viewBox="0 0 1440 160" className="w-full h-50" preserveAspectRatio="none">
          <defs>
          ...
          <path d="M0,0 Q720,320 1440,0 L1440,160 L0,160 Z" fill="url(#waveGradient1)" />
        </svg>
      </div>
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
        <svg viewBox="0 0 1440 160" className="w-full h-50" preserveAspectRatio="none">
          ...
          <path d="M0,0 Q720,320 1440,0 L1440,160 L0,160 Z" fill="url(#waveGradient2)" />
        </svg>
      </div>
              ...
              {items.map((_, i) => (
                <button
                  ...
                  className={`rounded-full transition-all ${
                    activeItem === i ? "w-4 h-1.5 bg-ospoly-navy" : "w-1.5 h-1.5 bg-gray-200"
                  }`}
                />
              ))}
            </div>
