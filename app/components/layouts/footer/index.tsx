...
// components/FooterServer.tsx  (no "use client" — this stays a server component)
import { sanityFetch } from "@/sanity/lib/live"; // wherever your sanityFetch lives
import { getFooterLinksQuery } from "@/sanity/lib/queries";
import { SanityFooterDoc } from "@/types";
import OspolyFooter from "./FooterSever";


export default async function FooterServer() {
  const { data } = await sanityFetch({ query: getFooterLinksQuery }).catch(
    () => ({ data: null })
  );

  return <OspolyFooter footerData={data as SanityFooterDoc | null} />;
}